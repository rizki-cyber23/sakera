...
def poster():
    ...
    l6 = ('     %s Multi Brute Force Facebook %s%s %sBy %sCyber-Dark     '%(P,J,Version,P,J))
    print('%s\n%s\n%s\n%s\n%s\n%s'%(l1,l2,l3,l4,l5,l6))
def poster2():
    l1 = ('     %s  _________       __                          '%(P))
    ...
    l6 = ('     %s Multi Brute Force Facebook %s%s %sBy %sCyber-Dark     '%(P,H,Version,P,H))
    print('%s\n%s\n%s\n%s\n%s\n%s'%(l1,l2,l3,l4,l5,l6))
def poster3():
    l1 = ('     %s  _________       __                          '%(P))
    ...
    l6 = ('     %s Multi Brute Force Facebook %s%s %sBy %sCyber-Dark     '%(P,B,Version,P,B))
    print('%s\n%s\n%s\n%s\n%s\n%s'%(l1,l2,l3,l4,l5,l6))
...
def pilih_menu():
    ...
    elif dc in ['2','02','b']  : tempel_sandi.append('Jangan');main_folls();system_login();metode();urut_crack();addpass();crack()
    elif dc in ['3','03','c']  : gabung_sandi.append('Direcode');namee()
    elif dc in ['4','04','d']  : tempel_sandi.append('Dasar');main_likers();system_login();metode();addpass();crack()
    elif dc in ['5','05','e']  : gabung_sandi.append('Bocah');message();system_login();metode();addpass();crack()
    elif dc in ['6','06','f']  : tempel_sandi.append('Goblok');komen();system_login();metode();addpass();crack()
    elif dc in ['7','07','g']  : gabung_sandi.append('Mampus');grup()
    elif dc in ['8','08','h']  : tempel_sandi.append('Error Kan');hashtag();system_login();metode();addpass();crack()
    ...
    elif dc in ['14','014','n']: tempel_sandi.append('Btw');suggestion();system_login();metode();addpass();crack()
